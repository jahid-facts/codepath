export const metadata = {
  title: 'Privacy Policy | SystemPath',
  description: 'How SystemPath stores local learning progress and optional technical visit analytics.',
}

export default function PrivacyPage() {
  return <main className="legal-page">
    <a className="legal-brand" href="/"><span>S</span><strong>SystemPath</strong></a>
    <p className="eyebrow">Privacy · গোপনীয়তা</p>
    <h1>Privacy policy</h1>
    <p className="legal-lead">SystemPath is designed for account-free learning. Your course progress stays on your device, and visit analytics are collected only after you choose to allow them.</p>
    ...
    <a className="primary-button" href="/">← Return to SystemPath</a>
  </main>
}
