...
const diagramBn = { Client: 'ক্লায়েন্ট', DNS: 'DNS', API: 'API', Database: 'ডেটাবেস', 'Load balancer': 'লোড ব্যালান্সার', Servers: 'সার্ভার', User: 'ব্যবহারকারী', 'Edge CDN': 'এজ CDN', Origin: 'অরিজিন', Storage: 'স্টোরেজ', App: 'অ্যাপ', Cache: 'ক্যাশ', Result: 'ফল', 'Primary DB': 'প্রাইমারি DB', Replica: 'রেপ্লিকা', Backup: 'ব্যাকআপ', Producer: 'প্রোডিউসার', Queue: 'কিউ', Workers: 'ওয়ার্কার', Router: 'রাউটার', 'Shard A/B': 'শার্ড A/B', 'Short URL': 'শর্ট URL', 'Edge cache': 'এজ ক্যাশ', 'Redirect API': 'রিডাইরেক্ট API', 'URL store': 'URL স্টোর', Clients: 'ক্লায়েন্ট', Gateway: 'গেটওয়ে', 'Message queue': 'মেসেজ কিউ', History: 'ইতিহাস', Creators: 'ক্রিয়েটর', 'Fan-out': 'ফ্যান-আউট', 'User inbox': 'ইউজার ইনবক্স', Ranker: 'র‍্যাঙ্কার', Upload: 'আপলোড', 'Object store': 'অবজেক্ট স্টোর', 'Transcode queue': 'ট্রান্সকোড কিউ', CDN: 'CDN' }
