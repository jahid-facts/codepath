...
export async function generateMetadata({params}){const {slug}=await params;const lesson=getManagedLesson(slug);return lesson?{title:`${lesson.title_en} | CodePath`,description:lesson.summary_en}:{}}
